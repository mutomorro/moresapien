...
oneLiner: "Holding a controversial position but retreating to a much more defensible one when challenged - then switching back once the pressure's off."
...
tags:
  ...
  - "social media"
  - "critical thinking"
howToSpotIt: "If someone makes a bold claim, gets challenged, retreats to something much milder ('that's not what I meant, I was just saying...'), and then later returns to the bold claim as if it was never challenged - that's the motte-and-bailey. Track the claim over time, not just in the moment."
thoughtToHoldOnto: "If someone keeps retreating to a position nobody disagrees with, ask yourself what position they're actually trying to advance."
relatedConcepts:
  - slug: "straw-man"
    note: "The straw man distorts the opponent's position. The motte-and-bailey distorts your own."
  - slug: "whataboutism"
  - slug: "gish-gallop"
