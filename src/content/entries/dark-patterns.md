---
title: "Dark Patterns"
oneLiner: "Deliberately deceptive design choices that trick people into doing things they didn't intend to do."
alsoKnownAs:
  - "Deceptive design"
  - "Manipulative design"
  - "Deceptive patterns"
...
This exploits the [framing effect](/framing-effect/) at a granular level. The information is technically present, but the framing makes it unreasonably difficult to act on.
...
This is [status quo bias](/status-quo-bias/) weaponised by design. People are naturally inclined to stick with defaults and avoid the effort of change. Dark patterns amplify that inclination by making the effort of change artificially high.
...
This is a form of [loaded language](/loaded-language/) applied to interface design. The words are chosen not to inform but to trigger an emotional response that overrides rational preference.
...
This exploits the [sunk cost fallacy](/sunk-cost-fallacy/) - you've already spent ten minutes choosing your flights, entering your details, and selecting your seats. Walking away from a surprise £15 fee feels like wasting all that effort, even though the fee itself is the only thing that changed.

### Urgency and scarcity theatre

"Only 2 left in stock." "This offer expires in 3:47." "17 other people are looking at this right now." These signals may be genuine, but in dark pattern design they are frequently fabricated or exaggerated to create a sense of [loss aversion](/loss-aversion/) - the fear that hesitation will cost you something.
...
This is where dark patterns intersect with [the attention economy](/the-attention-economy/). Your data has monetary value. Every friction point between you and your privacy settings is a design choice that increases the probability you'll surrender that value through inaction.
...
Use the [inversion](/inversion/) test. Ask: if this company were designing for my benefit, would the interface look like this? If the answer is no - if the design only makes sense as a way to extract something from you - you're looking at a dark pattern.
...
Support regulation and accountability. Individual vigilance is important, but it is not a substitute for systemic change. Dark patterns thrive because the incentives reward deception. Consumer protection laws, enforcement actions, and public pressure are the tools that change those incentives. Organisations like the [Electronic Frontier Foundation](https://www.eff.org/) and campaigns for digital rights are working to shift the balance - supporting them extends the protection beyond your own screen.
