---
title: "False Balance"
oneLiner: "Presenting two sides as equally valid when the evidence overwhelmingly favours one."
alsoKnownAs: ["bothsidesism", "balance bias", "false equivalence in media"]
category: "Rhetorical Device"
tags: ["media literacy", "misinformation", "critical thinking", "news media", "science", "politics", "debate"]
howToSpotIt: "When a debate is presented as having 'two sides', ask whether the evidence is actually split. If 97 experts agree and 3 disagree, a panel with one from each side isn't balanced - it's misleading."
thoughtToHoldOnto: "Balance is a principle of fairness, not a principle of truth. Giving equal weight to unequal evidence doesn't make coverage fair - it makes it wrong."
whyItMattersNow: "From climate change to vaccine safety, false balance in media has turned settled science into apparent controversy - with real consequences for public health and policy."
relatedConcepts:
  - slug: "false-equivalence"
    note: "False equivalence is the logical fallacy; false balance is the media practice that institutionalises it."
  - slug: "framing-effect"
    note: "False balance is a specific kind of framing - it frames a near-consensus as a genuine debate."
