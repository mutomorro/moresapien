...
oneLiner: "Drawing a broad conclusion from too few examples."
alsoKnownAs: ["overgeneralisation", "sweeping generalisation", "jumping to conclusions"]
category: "Logical Fallacy"
tags: ["critical thinking", "social dynamics", "media literacy", "everyday life", "news media", "politics"]
howToSpotIt: "When a broad claim is supported by one or two examples, ask: is this sample big enough and varied enough to justify the conclusion? One bad meal doesn't make a bad restaurant. One rude encounter doesn't define a nation."
thoughtToHoldOnto: "The plural of anecdote is not data. No matter how vivid the story."
relatedConcepts:
  - slug: "availability-heuristic"
    note: "Vivid examples feel representative even when they aren't - the availability heuristic is what makes hasty generalisations feel so convincing."
  - slug: "confirmation-bias"
    note: "Once a generalisation is formed, confirmation bias preserves it - we notice every confirming example and ignore every exception."
