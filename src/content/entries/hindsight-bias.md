...
oneLiner: "After something happens, we convince ourselves we knew it all along."
alsoKnownAs: ["the knew-it-all-along effect", "creeping determinism"]
category: "Cognitive Bias"
tags: ["decision-making", "critical thinking", "everyday life", "politics", "workplace", "news media"]
howToSpotIt: "When you hear someone (including yourself) say 'I knew that was going to happen' or 'it was obvious', ask: did they actually predict it beforehand, or are they rewriting history? If there's no record of the prediction, the hindsight is probably doing the talking."
thoughtToHoldOnto: "The past always looks inevitable from the future. That's an illusion, not insight."
relatedConcepts:
  - slug: "confirmation-bias"
    note: "Hindsight bias is partly driven by confirmation bias - after the outcome, we selectively remember the evidence that pointed toward it."
  - slug: "availability-heuristic"
    note: "Once something has happened, the outcome is vivid and available - making it feel like it was always the most likely result."
