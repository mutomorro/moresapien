...
oneLiner: "The tendency to see objects, tools, and ideas only in terms of their conventional use, making it harder to find creative solutions."
alsoKnownAs:
  - "Design fixation"
  - "Mental set"
...
tags:
  ...
  - "workplace"
  - "decision-making"
howToSpotIt: "When you're stuck on a problem, ask whether you're limiting yourself by thinking about your resources in their usual terms. A screwdriver is a tool for turning screws - but it's also a lever, a wedge, a pointer, and a weight. Functional fixedness is the invisible box around your thinking."
thoughtToHoldOnto: "Every object has more uses than the one it was designed for. Every idea has more applications than the one you learned it for."
whyItMattersNow: "In an era that prizes innovation and creative problem-solving, functional fixedness is one of the most common invisible barriers. The tools and frameworks we already have could solve problems we haven't considered - if we could see past their labels."
relatedConcepts:
  - slug: "first-principles-thinking"
    note: "First principles thinking is the direct antidote to functional fixedness - it strips away conventional use and asks what the components can do."
  - slug: "inversion"
    note: "Inversion helps overcome functional fixedness by forcing you to think about a problem from the opposite direction."
  - slug: "occams-razor"
    note: "Occam's razor favours simple solutions, which often require seeing familiar resources in unfamiliar ways - exactly what functional fixedness prevents."
  - slug: "map-is-not-the-territory"
    note: "Functional fixedness is a case of confusing the map for the territory - confusing the label we give something with the thing itself."
  - slug: "anchoring-bias"
    note: "The conventional use of an object acts as an anchor that constrains creative thinking about alternative uses."
---
...
The concept was first identified by Gestalt psychologist [Karl Duncker in 1945](https://en.wikipedia.org/wiki/Functional_fixedness), in his famous "candle problem" experiment. Participants were given a candle, a box of tacks, and a book of matches, and asked to attach the candle to the wall so it could burn without dripping wax on the table. The solution requires seeing the box of tacks not as a container (its current function) but as a shelf (a new function) - tack the box to the wall and place the candle on top. Most participants struggled because they could not see past the box's current role as a tack container.
...
Functional fixedness connects to a family of biases about how we categorise and use knowledge. First principles thinking and [inversion](/inversion/) are direct countermeasures. The [law of the instrument](/law-of-the-instrument/) is a close cousin - the tendency to over-rely on a familiar tool for every problem. And the broader lesson of [map is not the territory](/map-is-not-the-territory/) applies directly: the label we give something is not the thing itself, and confusing the two limits what we can do with it.
