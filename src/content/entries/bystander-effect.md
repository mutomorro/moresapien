...
oneLiner: "The more people who witness an emergency, the less likely any one person is to help."
alsoKnownAs: ["bystander apathy", "Genovese syndrome", "diffusion of responsibility (related)"]
category: "Psychological Phenomenon"
tags: ["social dynamics", "everyday life", "critical thinking", "psychology"]
howToSpotIt: "When you see something wrong and your first thought is 'someone else will deal with it', you're inside the bystander effect. The very fact that others are present is reducing your sense of personal responsibility. The antidote is to act as if you're the only one who can."
thoughtToHoldOnto: "Everyone is waiting for someone else to go first. Which means nobody goes at all - unless you decide to be the someone."
relatedConcepts:
  - slug: "pluralistic-ignorance"
    note: "Pluralistic ignorance feeds the bystander effect - when nobody reacts, each person interprets the group's inaction as a signal that action isn't needed."
  - slug: "tragedy-of-the-commons"
    note: "Both involve the gap between individual and collective responsibility - each person assumes someone else will carry the burden."
  - slug: "normalcy-bias"
