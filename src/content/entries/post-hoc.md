---
title: "Post Hoc"
oneLiner: "Assuming that because one thing followed another, the first thing caused the second."
alsoKnownAs: ["post hoc ergo propter hoc", "false cause", "correlation is not causation", "after this therefore because of this"]
category: "Logical Fallacy"
tags: ["critical thinking", "science", "media literacy", "decision-making", "everyday life", "news media"]
howToSpotIt: "When someone claims X caused Y, ask: is there a plausible mechanism connecting them, or did they just happen in sequence? Could both be caused by a third factor? Would Y have happened anyway without X?"
thoughtToHoldOnto: "Sequence is not causation. The sun rises after the rooster crows, but the rooster is not in charge of the sun."
relatedConcepts:
  - slug: "confirmation-bias"
    note: "Confirmation bias locks in post hoc reasoning - once we believe X caused Y, we selectively notice every time the pattern seems to repeat."
  - slug: "illusory-truth-effect"
    note: "If a false causal claim is repeated often enough, it starts to feel established - the mechanism behind many persistent myths."
