...
oneLiner: "Every model of reality is a simplification - useful, but never the full picture."
alsoKnownAs: ["the map-territory relation", "Korzybski's dictum", "all models are wrong, some are useful"]
category: "Mental Model"
tags: ["critical thinking", "decision-making", "science", "systems", "everyday life"]
howToSpotIt: "When someone presents a model, a statistic, a framework, or a plan as if it captures the full reality, remember: it doesn't. The question isn't whether the map is perfect - it never is. The question is whether the things it leaves out matter for the decision you're making."
thoughtToHoldOnto: "The menu is not the meal. The org chart is not the organisation. The model is not the world. Useful? Often. Complete? Never."
relatedConcepts:
  - slug: "first-principles-thinking"
    note: "First principles thinking is a way of going back to the territory when the existing maps are misleading."
  - slug: "naive-realism"
    note: "Naive realism is the belief that your map IS the territory - that your perception of reality is reality itself."
  - slug: "framing-effect"
