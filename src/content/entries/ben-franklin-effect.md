...
oneLiner: "We grow to like people we've done favours for, not just people who've done favours for us."
alsoKnownAs:
  - "Effort justification in relationships"
  - "Reverse reciprocity"
...
tags:
  ...
  - "self-deception"
  - "critical thinking"
howToSpotIt: "Notice when you feel warmly towards someone you've helped. Ask yourself: do I genuinely like this person, or has the act of helping them changed how I feel? The favour came first. The fondness followed."
thoughtToHoldOnto: "We don't just do things for people we like. We like people because we've done things for them."
whyItMattersNow: "From onboarding flows that ask you to customise a profile before you've even decided to stay, to charities that ask for a signature before a donation, the Ben Franklin effect is built into the architecture of modern persuasion. Once you've invested even a small effort, your brain starts justifying why it was worth it."
relatedConcepts:
  - slug: "cognitive-dissonance"
    note: "The Ben Franklin effect is cognitive dissonance in action - we helped them, so we must like them, because the alternative is admitting we acted irrationally"
  - slug: "motivated-reasoning"
    note: "Motivated reasoning is the engine that powers the Ben Franklin effect - once we've invested effort, we reason our way into believing it was the right call"
  - slug: "affect-heuristic"
    note: "The affect heuristic means our feelings guide our judgements - and the Ben Franklin effect shows that actions can reshape those feelings after the fact"
  - slug: "sunk-cost-fallacy"
    note: "Both the sunk cost fallacy and the Ben Franklin effect involve justifying past investments - one with money and time, the other with social effort"
  - slug: "effort-justification"
    note: "Effort justification is the broader principle - we value things we've worked for. The Ben Franklin effect is the social version: we value people we've helped"
  - slug: "social-proof"
    note: "The Ben Franklin effect can create social proof feedback loops - helping someone leads to liking them, which leads to publicly supporting them, which signals to others that they're worth supporting"
furtherReading:
  - title: "Ben Franklin effect - Wikipedia"
    url: "https://en.wikipedia.org/wiki/Ben_Franklin_effect"
  - title: "Cognitive dissonance - Simply Psychology"
    url: "https://www.simplypsychology.org/cognitive-dissonance.html"
---
