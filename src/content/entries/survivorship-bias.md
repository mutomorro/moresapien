...
oneLiner: "We only see the winners, so we misjudge what it takes to succeed."
alsoKnownAs:
  - "Survivor bias"
  - "Selection bias"
...
tags:
  ...
  - "workplace"
  - "science"
howToSpotIt: "When someone points to a success story as proof that a strategy works, ask: how many people tried the same thing and failed? If you're only hearing from the survivors, the story is incomplete."
thoughtToHoldOnto: "The graveyard of failed businesses, ignored artists, and forgotten ideas doesn't give interviews."
relatedConcepts:
  - slug: "availability-heuristic"
    note: "We overestimate the likelihood of success because success stories are more visible than failures"
