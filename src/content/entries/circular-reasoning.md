...
oneLiner: "An argument that uses its own conclusion as one of its premises - going round in circles without proving anything."
alsoKnownAs:
...
tags:
  ...
  - "debate"
  - "philosophy"
howToSpotIt: "Ask yourself: is the evidence for this claim just a restatement of the claim itself? If you removed the conclusion, would the argument collapse? If someone's proof for X is just X said differently, you're going in circles."
thoughtToHoldOnto: "An argument that assumes what it's trying to prove has never left the starting line."
whyItMattersNow: "In a world of confident headlines and algorithmic echo chambers, circular reasoning hides in plain sight. It sounds convincing because the conclusion and the premise agree with each other - but agreement isn't evidence. Spotting the loop is one of the most useful critical thinking skills you can develop."
relatedConcepts:
  - slug: "straw-man"
    note: "Both fallacies distort what's being argued, but circular reasoning does it by looping back to the start rather than misrepresenting an opponent."
  - slug: "confirmation-bias"
    note: "Confirmation bias makes circular reasoning feel satisfying - the conclusion confirms the belief you started with."
  - slug: "ad-hominem"
    note: "Another common logical fallacy that derails arguments by attacking the person rather than engaging with the claim."
...
This is one reason why circular reasoning is so common in [rhetoric and persuasion](/appeal-to-emotion/). A speaker who sounds certain can carry an audience past the missing evidence. The tone does the work that logic should be doing.
...
This is [a pattern that short-circuits thinking](/thought-terminating-cliche/). The response uses the rule's existence as justification for following it, without addressing whether the rule is fair, useful, or relevant. You'll hear this in families, schools, workplaces, and governments.
...
Media commentary sometimes falls into similar loops. A commentator might argue that a story is significant because everyone is talking about it, while the reason everyone is talking about it is that media outlets declared it significant. This feedback loop - where coverage creates the importance that justifies the coverage - is closely related to the [bandwagon effect](/bandwagon-effect/) and the dynamics of social proof.
...
In philosophy, circular reasoning raises deep questions about whether any system of knowledge can fully justify itself without some foundational assumptions. This is known as the [Münchhausen trilemma](https://en.wikipedia.org/wiki/M%C3%BCnchhausen_trilemma), named after the fictional baron who claimed to have pulled himself out of a swamp by his own hair.
...
A circular argument delivered with authority can bypass our critical filters. This connects to the [halo effect](/halo-effect/) - if we trust the speaker, we're less likely to scrutinise their logic. A confident tone creates a sense that evidence has been given, even when it hasn't.
...
When we already believe the conclusion, circular reasoning feels satisfying. [Confirmation bias](/confirmation-bias/) plays a significant role here. We're not looking for holes in arguments that align with what we think. The circle feels like a complete shape, not a missing one.
...
A [straw man](/straw-man/) misrepresents someone else's argument to make it easier to attack. Circular reasoning doesn't misrepresent anything - it simply doesn't provide any actual support. One distorts; the other loops.
...
This matters particularly in workplaces and relationships, where [motivated reasoning](/motivated-reasoning/) can make people defensive when their logic is questioned. A collaborative approach - "help me understand the evidence" - usually gets further than a combative one.
...
When you search for something online, the results that appear most often are the ones that have been linked to most frequently. If many sources repeat the same unsupported claim, it can feel like independent confirmation - but it might just be the same circular argument echoed across multiple platforms. This is the digital version of the old advertising principle: say it often enough and it starts to sound true, a dynamic closely tied to the [availability heuristic](/availability-heuristic/).
