...
oneLiner: "When someone redefines a group to exclude counterexamples rather than accepting that the counterexamples disprove their claim."
alsoKnownAs:
...
tags:
  ...
  - "tribalism"
  - "critical thinking"
howToSpotIt: "Watch for group definitions that mysteriously narrow after a counterexample appears. If someone says 'no real X would do Y,' ask whether they defined 'real X' that way before the example came up - or only after."
thoughtToHoldOnto: "If your definition of a group has to keep changing to exclude the people who embarrass it, the definition isn't describing reality. It's protecting an idealisation."
whyItMattersNow: "In an era of intense identity politics on all sides, the No True Scotsman fallacy lets groups disown their worst members without examining the conditions that produced them. It blocks honest reckoning."
relatedConcepts:
  - slug: "moving-the-goalposts"
    note: "The broader pattern of shifting criteria after evidence is presented"
  - slug: "in-group-out-group-bias"
    note: "The tribal loyalty that motivates the impulse to protect the group's image"
  - slug: "circular-reasoning"
    note: "The redefinition creates a circular argument: real members don't do X, so anyone who does X isn't a real member"
  - slug: "hasty-generalisation"
    note: "The opposite error - judging a whole group by its worst members"
  - slug: "cognitive-dissonance"
    note: "The discomfort of a counterexample that threatens group identity drives the redefinition"
---
...
This is closely related to [circular reasoning](/circular-reasoning/). The redefined argument becomes circular: real members of the group don't do X, and we know they don't do X because anyone who does X isn't a real member. The claim can never be disproven because it has been made unfalsifiable.

It also connects to [moving the goalposts](/moving-the-goalposts/) - the broader pattern of shifting criteria after evidence is presented. No True Scotsman is a specific variant where the goalposts being moved are the boundaries of a group's identity.
...
This impulse is driven by [in-group/out-group bias](/in-group-out-group-bias/) - the deep need to see your group as fundamentally good. Acknowledging that a genuine member of your group has done something reprehensible creates [cognitive dissonance](/cognitive-dissonance/) - a tension between "my group is good" and "this member of my group did a bad thing." The No True Scotsman fallacy resolves that tension by simply removing the person from the group.
...
The social cost is significant. People who don't conform to the idealised definition are marginalised, excluded, or told their identity isn't authentic. [Conformity bias](/conformity-bias/) compounds the pressure - the desire to belong makes people suppress aspects of themselves that don't fit the narrowed definition.
...
There's also a [fundamental attribution error](/fundamental-attribution-error/) at play. We tend to attribute bad behaviour within our own group to individual character flaws rather than group dynamics. "That person was an outlier" is more comfortable than "our group's culture enabled that." The No True Scotsman fallacy takes this one step further - not just an outlier, but not a member at all.

And it connects to [naive realism](/naive-realism/) - the conviction that your understanding of what the group stands for is the correct one, and anyone who interprets it differently is mistaken rather than legitimately different.
