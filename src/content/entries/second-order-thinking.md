...
oneLiner: "Asking 'and then what?' - looking beyond the immediate consequences to what happens next."
...
tags:
  ...
  - "everyday life"
  - "workplace"
howToSpotIt: "When someone proposes a solution, ask 'and then what happens?' If the answer reveals new problems, you're doing second-order thinking. Most bad decisions look good if you only consider the first-order effects."
thoughtToHoldOnto: "Every action has consequences, and every consequence has consequences. The trick is thinking one step further than everyone else."
relatedConcepts:
  - slug: "occams-razor"
