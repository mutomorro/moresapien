---
title: "Victim-Perpetrator Cycle"
oneLiner: "Groups that have suffered persecution can, once they gain power, go on to persecute others - often using their past suffering as justification."
alsoKnownAs:
  - "Cycle of collective aggression"
  - "Transgenerational trauma to aggression"
  - "Oppressed-becomes-oppressor dynamic"
...
tags:
  ...
  - history
  - persecution
howToSpotIt: "Watch for groups that invoke historical suffering to justify present-day aggression or to deflect criticism of their actions. When the phrase *never again* shifts from a universal vow to an exclusive licence - when it means *never again to us* rather than *never again to anyone* - the cycle may be turning. Competitive victimhood, where a group insists its past pain outweighs the current pain of those it is harming, is a key signal."
thoughtToHoldOnto: "Suffering does not immunise a group against causing suffering. Power tempts everyone equally, and unhealed wounds can become weapons."
whyItMattersNow: "In an era of identity-based politics, historical grievance is a powerful currency. Groups across the political spectrum invoke ancestral trauma to claim moral authority - and sometimes to silence legitimate criticism of their present conduct. Recognising this pattern is not about diminishing anyone's past pain. It is about insisting that pain must never become a permission slip."
relatedConcepts:
  - slug: "moral-licensing"
    note: "Historical suffering can function as a moral credit, licensing behaviour that would otherwise be condemned"
  - slug: "in-group-out-group-bias"
    note: "The persecuted group's hardened identity boundaries can flip from defensive to aggressive"
  - slug: "cognitive-dissonance"
    note: "Members may struggle to reconcile their group's victim identity with evidence of perpetration"
