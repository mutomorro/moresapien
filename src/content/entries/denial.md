---
title: "Denial"
oneLiner: "Refusing to accept reality because it's too threatening to process."
alsoKnownAs: ["wilful blindness", "the ostrich effect"]
category: "Psychological Defence"
tags: ["psychology", "self-deception", "everyday life", "critical thinking", "relationships"]
howToSpotIt: "Denial is hardest to spot in yourself - by definition, you don't know you're doing it. The clues are indirect: avoiding conversations about a topic, feeling disproportionately angry when someone raises it, or finding yourself physically unable to engage with certain information. If the thought 'I don't want to think about that' keeps recurring, there may be something you're not letting yourself see."
thoughtToHoldOnto: "Denial doesn't make the threat go away. It just makes you go away from the threat - and the threat keeps growing while you're not looking."
relatedConcepts:
  - slug: "normalcy-bias"
    note: "Normalcy bias and denial work together - normalcy bias says 'it's fine', denial says 'I refuse to consider that it might not be'."
  - slug: "rationalisation"
    note: "Rationalisation is often the next step after denial begins to crack - when you can no longer deny the facts, you start explaining them away."
  - slug: "cognitive-dissonance"
    note: "Denial is the most blunt instrument for managing cognitive dissonance - rather than reconcile contradictory information, you simply reject one side of it."
