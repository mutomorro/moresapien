---
title: "Scapegoating"
oneLiner: "Blaming a person or group for problems they didn't cause."
alsoKnownAs: ["blame displacement", "othering"]
category: "Rhetorical Device"
tags: ["politics", "social dynamics", "manipulation", "media literacy", "critical thinking", "misinformation"]
howToSpotIt: "When blame is directed at a specific group - especially a vulnerable one - ask whether they actually have the power to have caused the problem. If a struggling economy is blamed on immigrants rather than policy decisions, the finger is pointing at the easiest target, not the most accurate one."
thoughtToHoldOnto: "Scapegoating works not because the target is guilty, but because blaming them is easier than understanding the real problem."
whyItMattersNow: "Scapegoating is the rhetorical engine behind some of the most dangerous political movements in history - and it remains a primary tool of populism worldwide."
relatedConcepts:
  - slug: "in-group-out-group-bias"
    note: "Scapegoating exploits the in-group/out-group divide - it only works when the target is already seen as 'other'."
  - slug: "availability-heuristic"
    note: "Visible minorities make easy scapegoats because they're cognitively available - easy to picture and easy to blame."
  - slug: "false-dilemma"
    note: "Scapegoating often relies on a false dilemma: either we deal with this group, or the problem gets worse."
