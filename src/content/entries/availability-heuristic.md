...
oneLiner: "We judge how likely something is based on how easily we can think of an example - not on how often it actually happens."
alsoKnownAs: ["availability bias", "availability error", "the availability shortcut"]
category: "Cognitive Bias"
tags: ["decision-making", "fear", "media literacy", "news media", "critical thinking", "everyday life", "risk"]
...
relatedConcepts:
  ...
  - slug: "negativity-bias"
    note: "Negative events are more vivid and memorable, making them more available and therefore seeming more likely."
  - slug: "framing-effect"
    note: "Media framing determines which events become vivid and available - and therefore which risks we overestimate."
...
This is because personal stories and vivid anecdotes are far more available than abstract statistics. A number on a page doesn't lodge in memory the way a friend's story does. The [affect heuristic](/affect-heuristic/) works alongside availability here: the emotional charge of a vivid example makes it both more memorable and more influential, creating a double bias.
