---
title: "Source Laundering"
oneLiner: "Passing unreliable information through a chain of increasingly credible-looking sources until it appears legitimate."
alsoKnownAs:
...
tags:
  ...
  - "critical thinking"
  - "social media"
howToSpotIt: "Trace any surprising claim back through its chain of sources. If the trail leads to an anonymous blog post, an unsourced report, or a single unverified account - despite the claim now appearing in seemingly reputable outlets - you may be looking at source laundering. The red flag is a claim that looks well-sourced on the surface but has no solid origin underneath."
thoughtToHoldOnto: "A lie does not become true by being repeated by someone more famous."
whyItMattersNow: "The speed of online information sharing makes source laundering easier than ever. A false claim can travel from an anonymous post to a mainstream headline within hours, gathering credibility at each step without ever being verified at any of them."
relatedConcepts:
  - slug: "firehose-of-falsehood"
    note: "Source laundering provides the appearance of evidence for claims that the firehose strategy spreads at volume."
  - slug: "availability-heuristic"
    note: "Laundered claims feel more credible partly because we see them repeated across multiple apparently independent sources."
  - slug: "confirmation-bias"
    note: "People are less likely to trace a claim's sources when it confirms what they already believe."
  - slug: "social-proof"
...
Viral sharing also creates a kind of informal laundering. When thousands of people share a claim, it acquires a sense of being widely known and widely accepted - a form of [social proof](/social-proof/) that has nothing to do with whether the claim is true. Each share adds a thin layer of apparent credibility, not because the sharer has verified anything, but because the sheer volume of sharing makes the claim feel established.
...
This technique is particularly effective because it exploits the [availability heuristic](/availability-heuristic/). When people encounter the same claim in multiple outlets, they tend to judge it as more likely to be true - even if all those outlets are ultimately drawing on the same unverified source. The repetition creates a feeling of corroboration that is entirely manufactured.
...
This trust shortcut interacts with [confirmation bias](/confirmation-bias/) in a predictable way. When a laundered claim aligns with what someone already believes, they are even less likely to question its provenance. The claim feels right, it appears in a credible outlet, and there is no motivation to dig deeper.
