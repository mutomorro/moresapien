...
oneLiner: "When a product, platform, or system becomes more valuable to each user as more people use it - creating powerful winner-take-all dynamics."
alsoKnownAs:
...
tags:
  ...
  - "business"
  - "systems"
howToSpotIt: "Ask: does this product become more useful as more people adopt it? A phone network with one user is worthless. With a billion users, it's indispensable. That escalating value is the network effect at work. You'll also spot it in the difficulty of leaving platforms where everyone you know is already present."
thoughtToHoldOnto: "The strongest lock-in isn't a contract. It's the fact that everyone you need to reach is already there."
whyItMattersNow: "Network effects explain why a handful of tech platforms dominate global communication, why switching from one social network to another feels impossible, and why markets for networked products tend toward monopoly rather than competition."
relatedConcepts:
  - slug: "tipping-points"
    note: "Network effects often exhibit tipping point dynamics - once adoption reaches a threshold, growth accelerates"
  - slug: "feedback-loops"
    note: "Network effects are a positive feedback loop - more users create more value, which attracts more users"
  - slug: "emergence"
    note: "The value of a network emerges from connections between users, not from the product itself"
  - slug: "tragedy-of-the-commons"
    note: "Network effects can create commons problems when platforms become too dominant to leave"
  - slug: "bandwagon-effect"
    note: "The psychological parallel - people join because others have joined"
---
...
This lock-in connects to [tragedy of the commons](/tragedy-of-the-commons/). The platform becomes a shared resource that everyone depends on, but no individual can control. If the platform's owner makes decisions that harm users - privacy erosion, algorithm manipulation, advertising saturation - individual users are often trapped because the network they need is only available through that platform.

The [sunk cost fallacy](/sunk-cost-fallacy/) reinforces lock-in. Years of content, connections, and digital history make leaving feel like a loss, even when the platform itself has deteriorated. People stay not because the platform is good, but because they've invested too much to leave.

## Network effects and tipping points

Network effects often exhibit [tipping point](/tipping-points/) dynamics. Growth is slow until the network reaches a critical mass, then accelerates rapidly.
...
Even social norms function through network effects. The more people who follow a norm, the more costly it is to deviate. [Social proof](/social-proof/) is essentially a network effect applied to behaviour - the value of conforming increases with the number of people already conforming.
