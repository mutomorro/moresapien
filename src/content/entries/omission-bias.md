---
title: "Omission Bias"
oneLiner: "The tendency to judge harmful actions as worse than equally harmful inactions, even when doing nothing causes more damage."
alsoKnownAs:
...
tags:
  ...
  - "moral-reasoning"
  - "everyday life"
howToSpotIt: "When you find yourself choosing to do nothing because it feels safer or more morally neutral than acting, ask: is inaction genuinely less harmful here, or does it just feel that way? Not deciding is itself a decision, and its consequences are just as real."
thoughtToHoldOnto: "Doing nothing is not the same as doing no harm. Sometimes the most damaging choice is the one you didn't make."
whyItMattersNow: "From vaccine hesitancy to climate policy to corporate regulation, omission bias shapes some of the most consequential decisions societies make. The preference for inaction over action - even when inaction causes more harm - is a quiet engine of preventable suffering."
relatedConcepts:
  - slug: "status-quo-bias"
    note: "Omission bias and status quo bias reinforce each other - the preference for inaction protects the current state of affairs, even when the current state is harmful."
  - slug: "loss-aversion"
    note: "Omission bias is partly driven by loss aversion - the harms caused by action feel like losses we chose, while harms caused by inaction feel like the natural order."
  - slug: "framing-effect"
    note: "Whether a choice is framed as an action or an omission changes how people evaluate it morally, even when the outcomes are identical."
  - slug: "normalcy-bias"
    note: "Normalcy bias - the assumption that things will continue as they are - encourages the inaction that omission bias protects from moral scrutiny."
  - slug: "motivated-reasoning"
    note: "Omission bias gives motivated reasoning a comfortable hiding place - 'I didn't do anything' feels like a defence even when it isn't."
---
...
This difference in perceived causation is psychologically powerful. It is connected to [loss aversion](/loss-aversion/) - a harm caused by your action feels like a loss you inflicted, while a harm caused by your inaction feels like a loss that happened naturally. The emotional weight is different even when the factual outcomes are the same.
...
The [framing effect](/framing-effect/) plays a direct role here. When a treatment is framed as "preventing harm," it feels different from when the same treatment is framed as "intervening" - even though the medical reality is identical.
...
This is where omission bias intersects with [status quo bias](/status-quo-bias/) - the broader preference for keeping things as they are. Together, these biases create a powerful force against change, even when the status quo is producing ongoing harm.
