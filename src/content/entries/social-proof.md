---
title: "Social Proof"
oneLiner: "Looking to other people's behaviour to decide what's correct."
alsoKnownAs: ["informational social influence", "herd behaviour", "the wisdom (or madness) of crowds"]
category: "Psychological Phenomenon"
tags: ["social dynamics", "persuasion", "advertising", "social media", "everyday life", "decision-making"]
howToSpotIt: "When your decision is based on what others are doing rather than your own assessment - choosing the busy restaurant, buying the bestseller, adopting the popular opinion - social proof is at work. Ask: would I make this choice if nobody else had made it first?"
thoughtToHoldOnto: "A million people can be wrong at the same time. Popularity is information, not proof."
relatedConcepts:
  - slug: "bandwagon-effect"
    note: "The bandwagon effect is social proof applied to beliefs and trends - joining in because others have."
  - slug: "pluralistic-ignorance"
    note: "Social proof's dark twin - when everyone follows the group signal, but the signal itself is wrong because nobody actually believes it."
  - slug: "illusory-truth-effect"
    note: "Social proof and repetition reinforce each other - the more people repeat something, the truer it feels."
  - slug: "authority-bias"
