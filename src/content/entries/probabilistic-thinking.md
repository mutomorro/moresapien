...
oneLiner: "Thinking in likelihoods rather than certainties - because almost nothing is truly yes or no."
alsoKnownAs: ["Bayesian thinking", "thinking in bets", "calibrated uncertainty"]
category: "Mental Model"
tags: ["decision-making", "critical thinking", "science", "everyday life", "news media", "risk"]
howToSpotIt: "When you catch yourself saying 'that will definitely happen' or 'that's impossible', translate it into a probability. If you'd put it at 90% rather than 100%, that remaining 10% matters more than you think. And if your confidence is at 50%, you're really just guessing."
thoughtToHoldOnto: "Certainty feels good. Probability is more honest. The world runs on odds, not absolutes."
relatedConcepts:
  - slug: "availability-heuristic"
    note: "The availability heuristic is the enemy of probabilistic thinking - it substitutes 'easy to imagine' for 'likely to happen'."
  - slug: "confirmation-bias"
    note: "Confirmation bias distorts our probability estimates by overweighting evidence that supports our existing beliefs."
  - slug: "first-principles-thinking"
    note: "First principles gives you the foundation; probabilistic thinking helps you reason about uncertain outcomes built on that foundation."
  - slug: "occams-razor"
