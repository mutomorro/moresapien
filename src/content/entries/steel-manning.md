---
title: "Steel Manning"
oneLiner: "The practice of engaging with the strongest possible version of someone's argument, rather than the weakest - the opposite of a straw man."
alsoKnownAs:
  - "Steelmanning"
  - "Steel man argument"
...
howToSpotIt: "You're steel manning when you can articulate someone's position so well that they say 'yes, that's exactly what I mean.' You're not steel manning if your version of their argument is more convenient for you to argue against."
thoughtToHoldOnto: "If you can only defeat the weakest version of an argument, you haven't defeated the argument. You've just made yourself feel clever."
whyItMattersNow: "In an era where most public debate is conducted by attacking caricatures of opposing views, steel manning is a quiet act of intellectual integrity. It doesn't mean you have to agree - it means you have to understand before you disagree."
relatedConcepts:
  - slug: "straw-man"
    note: "The exact opposite - attacking the weakest version of an argument rather than the strongest"
  - slug: "naive-realism"
    note: "Steel manning counteracts naive realism by forcing you to consider that others might have good reasons"
  - slug: "in-group-out-group-bias"
    note: "Tribal loyalty makes us more likely to straw man out-group arguments and steel man in-group ones"
  - slug: "confirmation-bias"
    note: "Steel manning requires actively seeking the strength in views you disagree with - the opposite of confirmation bias"
  - slug: "first-principles-thinking"
    note: "Both involve stripping away surface noise to get to the core logic"
---
...
This connects to [first-principles thinking](/first-principles-thinking/) - the practice of breaking arguments down to their foundational assumptions. Steel manning does something similar by stripping away the surface weaknesses of an argument to find its core logic.
...
In professional settings, steel manning creates environments where people feel safe to express dissenting views, because they know those views will be engaged with rather than dismissed. This directly counteracts [groupthink](/groupthink/) - when people know their ideas will be treated charitably, they're more likely to voice them.
...
Understanding the strongest case for a view you oppose means you can spot when someone is using [appeal to emotion](/appeal-to-emotion/) instead of logic, when they're relying on a [false dilemma](/false-dilemma/) to avoid engaging with alternatives, or when they're using [loaded language](/loaded-language/) to obscure a weak argument. You become a better critical thinker by taking opposing views more seriously, not less.
...
Some arguments are made in bad faith, and steel manning a bad-faith argument can give it more credibility than it deserves. [Sealioning](/sealioning/) - the tactic of asking endless "polite" questions to exhaust and frustrate - can exploit steel manning norms by treating every challenge as deserving of charitable engagement.
