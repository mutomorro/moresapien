...
oneLiner: "Demanding that someone disprove your claim, rather than proving it yourself."
alsoKnownAs: ["shifting the burden of proof", "argument from ignorance", "Russell's teapot"]
category: "Logical Fallacy"
tags: ["critical thinking", "debate", "science", "rhetoric", "media literacy", "politics"]
howToSpotIt: "When someone makes a claim and then challenges you to disprove it, they've shifted the burden. The person making the claim is responsible for providing evidence. 'You can't prove it's NOT true' is never a valid argument."
thoughtToHoldOnto: "The person who makes the claim carries the evidence. If they hand you the burden instead, they've handed you an empty bag."
relatedConcepts:
  - slug: "circular-reasoning"
    note: "Both make positions unfalsifiable - circular reasoning by looping back on itself, burden-shifting by demanding impossible disproof."
  - slug: "appeal-to-false-authority"
    note: "Sometimes the burden is shifted by invoking authority: 'Experts say X, prove them wrong' - even when the experts haven't provided evidence either."
  - slug: "post-hoc"
