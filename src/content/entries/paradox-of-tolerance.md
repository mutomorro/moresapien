...
oneLiner: "A tolerant society that tolerates intolerance will eventually be destroyed by it."
alsoKnownAs: ["Popper's paradox", "the tolerance trap", "the tolerance dilemma"]
category: "Political Theory"
tags: ["politics", "critical thinking", "social dynamics", "debate", "media literacy", "philosophy"]
howToSpotIt: "When someone demands tolerance for a position that would, if empowered, eliminate tolerance for others, you're inside the paradox. The test: does the idea being defended seek to extend freedom, or to remove it from specific groups?"
thoughtToHoldOnto: "Tolerance is not a suicide pact. Defending the right of others to speak is not the same as defending their right to silence everyone else."
whyItMattersNow: "As democratic societies debate the limits of free speech online and offline, Popper's paradox is more relevant than ever. The question isn't whether to draw a line - it's where, how, and who decides."
relatedConcepts:
  - slug: "overton-window"
    note: "The paradox of tolerance is about what happens at the edges of the Overton Window - when intolerant ideas are normalised into the range of acceptable debate."
  - slug: "false-balance"
    note: "False balance can enable the paradox - giving extremist positions equal airtime in the name of fairness helps normalise them."
  - slug: "false-dilemma"
    note: "The paradox is often misused as a false dilemma: 'either we tolerate everything or we censor everything.' Popper's point was more nuanced."
...
This is a genuine strategic challenge, not a theoretical exercise. The [motte-and-bailey](/motte-and-bailey/) fallacy is one of the key tactics: an intolerant movement presents a reasonable-sounding public position (the motte) while the real agenda (the bailey) is far more extreme. When challenged, they retreat to the motte. When unchallenged, they advance to the bailey. The effect is a gradual normalisation of ideas that would be rejected if stated openly.

The [Overton Window](/overton-window/) is the frame through which this normalisation operates. Each cycle of motte-and-bailey argumentation shifts the window slightly, making previously extreme positions feel a little more acceptable. Over time, the cumulative effect can be dramatic.
