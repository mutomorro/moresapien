...
oneLiner: "The tendency to favour people in your own group and view those outside it with suspicion, distrust, or hostility."
alsoKnownAs:
...
thoughtToHoldOnto: "The line between us and them is drawn by the mind, not by reality. And the mind draws it far more easily than most of us would like to admit."
whyItMattersNow: "Social media and algorithmic curation have supercharged in-group/out-group dynamics. Platforms thrive on tribal engagement - us versus them drives clicks, shares, and outrage. Political polarisation, online pile-ons, and the erosion of shared public discourse all have in-group/out-group bias at their foundations. Understanding it is a prerequisite for navigating a divided world with any integrity."
relatedConcepts:
  - slug: "naive-realism"
    note: "Believing your group sees reality clearly while the out-group is biased"
  - slug: "fundamental-attribution-error"
    note: "Out-group members' behaviour is attributed to character; in-group members get the benefit of context"
  - slug: "bandwagon-effect"
    note: "Group identity drives conformity - people adopt beliefs to maintain belonging"
  - slug: "social-proof"
...
When someone on your team makes an error, the [fundamental attribution error](/fundamental-attribution-error/) operates in their favour - you attribute it to circumstances. When someone on another team makes the same error, the attribution shifts to character. They are incompetent. Your person was just having a bad day.
...
[Whataboutism](/whataboutism/) is often the rhetorical expression of this dynamic. Rather than evaluating the behaviour on its own terms, the response is to redirect attention to comparable behaviour by the out-group - implicitly applying a different standard to each side.
...
[Social proof](/social-proof/) reinforces in-group/out-group bias by making group norms feel like objective truth. When everyone in your group holds a particular view, that view feels self-evidently correct. The [bandwagon effect](/bandwagon-effect/) amplifies this further - the more people in your group adopt a position, the more pressure there is to conform, and the more the position feels validated by sheer numbers rather than by evidence.
...
The out-group homogeneity effect dissolves when you engage with individuals rather than categories. A single conversation with a real person from an out-group can do more to disrupt stereotyping than any amount of abstract reasoning. This is not sentimental advice. It is supported by decades of contact theory research pioneered by [Gordon Allport](https://en.wikipedia.org/wiki/Contact_hypothesis).
