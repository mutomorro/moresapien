---
title: "Whataboutism"
oneLiner: "Responding to a criticism by pointing to someone else's wrongdoing instead of addressing the original point."
alsoKnownAs: ["whataboutery", "tu quoque", "appeal to hypocrisy", "the 'what about' defence"]
category: "Manipulation Tactic"
tags: ["bad faith", "debate", "politics", "propaganda", "media literacy", "social media", "critical thinking"]
howToSpotIt: "When someone responds to a criticism with 'what about...' followed by a different accusation, check whether the counter-accusation addresses the original point. If it doesn't - if it just redirects blame elsewhere - it's whataboutism. The counter-accusation may be true, but it doesn't answer the original charge."
thoughtToHoldOnto: "Two wrongs don't make one of them disappear. Someone else's failing doesn't cancel out yours."
whyItMattersNow: "Whataboutism has become one of the default moves in online argument and political debate. In a polarised environment where every criticism is met with a counter-accusation against the other side, the tactic makes genuine accountability almost impossible."
relatedConcepts:
  - slug: "red-herring"
    note: "Whataboutism is a specific type of red herring - it diverts from the issue by introducing a different accusation."
  - slug: "false-equivalence"
    note: "Whataboutism creates false equivalence by placing two unrelated wrongs side by side, implying they cancel each other out."
  - slug: "ad-hominem"
    note: "Whataboutism often shades into ad hominem - attacking the critic's standing to make the criticism rather than addressing the criticism itself."
  - slug: "straw-man"
...
Whataboutism collapses these separate questions into one, creating a [false equivalence](/false-equivalence/) where the two issues are treated as though they cancel each other out. The implied logic is: "Everyone does bad things, so nobody can be held accountable" - a conclusion that serves the interests of whoever wants to avoid scrutiny.
...
The [red herring](/red-herring/) nature of whataboutism is clearest here. The counter-accusation doesn't defend the accused's behaviour. It doesn't explain it, justify it, or contextualise it. It just points somewhere else. The audience follows the pointing finger and forgets the original question.
...
The [bandwagon effect](/bandwagon-effect/) can amplify this. If a "what about" response goes viral, the counter-accusation becomes the story - not the original criticism. The tactic succeeds not by winning the argument but by changing the subject at scale.

[Motivated reasoning](/motivated-reasoning/) enables whataboutism's persistence. People on each side of a dispute are motivated to accept whataboutism when it's used on their behalf and to reject it when it's used against them. The same tactic is seen as fair rebuttal or dishonest deflection depending on whose side you're on.
...
The [straw man](/straw-man/) fallacy is sometimes confused with whataboutism, but they work differently. A straw man distorts your argument and attacks the distortion. Whataboutism doesn't engage with your argument at all - it simply introduces a different one. [Moving the goalposts](/moving-the-goalposts/) is another neighbouring tactic: it accepts the frame of the argument but shifts the criteria for success, while whataboutism abandons the frame entirely.
...
[First principles thinking](/first-principles-thinking/) helps by refocusing on the original question. [Independent evaluation](/independent-evaluation/) helps by assessing each claim on its own terms rather than in relation to the other. And simply naming the tactic - "that's whataboutism" - can be enough to refocus a conversation, because the pattern is widely enough recognised that naming it carries its own weight.
