---
title: "Optimism Bias"
oneLiner: "The tendency to overestimate the likelihood of positive outcomes and underestimate the likelihood of negative ones happening to you."
alsoKnownAs:
...
tags:
  ...
  - "finance"
  - "workplace"
howToSpotIt: "Watch for the gap between what you believe will happen and what the evidence suggests is likely. If you're consistently surprised by setbacks, routinely underestimate how long things will take, or assume that risks apply to other people but not to you - optimism bias is at work."
thoughtToHoldOnto: "Hope is a wonderful motivator. It's a terrible forecaster."
whyItMattersNow: "From climate change timelines to personal financial planning, optimism bias shapes how individuals and societies prepare - or fail to prepare - for foreseeable challenges. Understanding it doesn't mean becoming pessimistic. It means planning honestly."
relatedConcepts:
  - slug: "normalcy-bias"
    note: "The assumption that things will continue as they are - a close cousin of optimism bias"
  - slug: "confirmation-bias"
    note: "We seek out information that supports our optimistic expectations"
  - slug: "hindsight-bias"
    note: "After things go wrong, we rewrite the story to feel we 'knew all along'"
  - slug: "probabilistic-thinking"
    note: "The mental model that helps counter optimism bias by working with actual likelihoods"
  - slug: "sunk-cost-fallacy"
    note: "Optimism about recovery keeps people investing in failing ventures"
---
...
This connects to [naive realism](/naive-realism/) - the broader tendency to believe that your perception of reality is accurate while others' perceptions are distorted. Optimism bias is naive realism applied to the future.
...
This connects to [hindsight bias](/hindsight-bias/). After a project overruns, people rewrite the narrative: "We couldn't have known about that problem." But often they could have - the base rate of delays was always high. They just didn't expect this time to be typical.
...
This isn't ignorance. These same people can accurately describe the risks in general terms. They know the statistics. They just don't believe the statistics apply to them. [Confirmation bias](/confirmation-bias/) supports the delusion - they notice the heavy smoker who lived to 95 and overlook the thousands who didn't.
...
[Normalcy bias](/normalcy-bias/) plays a closely related role - the assumption that because things have been stable, they will continue to be stable. Together, optimism bias and normalcy bias create a powerful cognitive cocktail that makes societies slow to respond to gradual threats.
...
Use [probabilistic thinking](/probabilistic-thinking/) when making important decisions. Instead of asking "what will happen?", ask "what's the range of things that could happen, and how likely is each?" This forces you out of a single optimistic scenario and into a more honest assessment of possibilities.
