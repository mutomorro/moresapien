---
title: "Inversion"
oneLiner: "Instead of asking how to succeed, ask how you would guarantee failure - then avoid those things."
alsoKnownAs: ["thinking backwards", "via negativa", "premortem thinking"]
category: "Mental Model"
tags: ["decision-making", "critical thinking", "workplace", "everyday life"]
howToSpotIt: "When you're stuck trying to solve a problem head-on, flip it. Instead of 'how do I make this project succeed?', ask 'what would definitely make this project fail?' The obstacles often become clearer from the other direction."
thoughtToHoldOnto: "Sometimes the fastest way forward is to look backwards. It's easier to avoid stupidity than to achieve brilliance."
relatedConcepts:
  - slug: "second-order-thinking"
    note: "Both are tools for thinking beyond the obvious - second-order thinking asks 'then what?', inversion asks 'what if the opposite?'"
  - slug: "first-principles-thinking"
    note: "Inversion and first principles thinking work beautifully together - strip back to fundamentals, then look at the problem from both directions."
