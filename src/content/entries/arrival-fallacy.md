...
oneLiner: "The belief that achieving a particular goal will make you permanently happy - followed by the discovery that it doesn't."
alsoKnownAs:
  - "Hedonic treadmill"
  - "When/then thinking"
...
tags:
  ...
  - "psychology"
  - "work"
howToSpotIt: "Listen for 'when/then' thinking in yourself: 'When I get the promotion, then I'll be happy.' 'When I finish the project, then I'll relax.' 'When I reach the goal, then I'll feel fulfilled.' The arrival fallacy lives in the gap between the anticipation and the actual experience of arriving."
thoughtToHoldOnto: "The finish line keeps moving because happiness was never at the finish line. It was in the running."
whyItMattersNow: "Social media is a gallery of other people's arrivals - promotions, purchases, milestones, achievements. It amplifies the arrival fallacy by making it seem like other people have found the happiness you're still chasing."
relatedConcepts:
  - slug: "loss-aversion"
    note: "Loss aversion makes the arrival fallacy worse - once you achieve something, the fear of losing it replaces the joy of gaining it."
  - slug: "cognitive-dissonance"
    note: "When arriving at a goal doesn't bring the expected happiness, cognitive dissonance can make you rationalise the disappointment rather than update the belief."
  - slug: "sunk-cost-fallacy"
    note: "The sunk cost fallacy can keep you pursuing a goal that no longer serves you, partly because the arrival fallacy promises that happiness is just ahead."
  - slug: "status-quo-bias"
    note: "After arriving, the new situation quickly becomes the new status quo - the baseline from which you evaluate future gains and losses."
  - slug: "framing-effect"
    note: "How we frame our goals - as destinations to reach rather than directions to move in - feeds the arrival fallacy."
---
...
The arrival fallacy connects to loss aversion (new gains become new baselines to protect), [cognitive dissonance](/cognitive-dissonance/) (rationalising the disappointment of arrival), the [sunk cost fallacy](/sunk-cost-fallacy/) (continuing to chase a goal that no longer serves you), and [social proof](/social-proof/) (seeing others' arrivals and wanting the same). Together, they describe a common human experience: the perpetual pursuit of a happiness that always seems to live just beyond the next milestone. Understanding the arrival fallacy does not mean abandoning ambition. It means redirecting attention from the finish line to the path.
