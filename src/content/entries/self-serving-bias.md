...
oneLiner: "The tendency to credit your successes to skill and your failures to circumstances."
alsoKnownAs:
...
This connects to the [fundamental attribution error](/fundamental-attribution-error/) in a revealing way. We tend to explain other people's failures as character flaws (they're lazy, they're incompetent) while explaining our own failures as situational (the deadline was impossible, the brief kept changing). Self-serving bias and the fundamental attribution error are two sides of the same coin - both protect your ego at the expense of understanding what happened.
...
This is closely related to [naive realism](/naive-realism/) - the belief that you see the world as it is, and that people who disagree with you are either uninformed, irrational, or biased. If you assume your perceptions are reliable, then your self-serving attributions will always seem perfectly reasonable.
...
Some degree of self-serving bias may be psychologically adaptive. Research suggests that people with mild depression tend to make more [realistic attributions](https://en.wikipedia.org/wiki/Depressive_realism) about their own role in events - a phenomenon sometimes called depressive realism. A small amount of self-serving bias might function as emotional insulation, helping people maintain the motivation to keep trying after setbacks.
...
The goal isn't to swing to the opposite extreme - blaming yourself for everything. It's to notice the asymmetry and correct for it. The people who learn fastest are usually the ones who can sit with the discomfort of [acknowledging their own contribution](/dunning-kruger-effect/) to a failure, rather than reflexively looking for someone or something else to blame.
