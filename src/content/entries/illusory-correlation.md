...
oneLiner: "Perceiving a relationship between two things when no meaningful connection exists - or when the connection is far weaker than it appears."
alsoKnownAs:
...
tags:
  ...
  - "media literacy"
  - "social dynamics"
howToSpotIt: "When two things seem linked, ask: am I remembering the times they occurred together more easily than the times they didn't? Do I have actual data showing a relationship, or just a feeling? The more unusual or emotionally charged both things are, the more likely the connection is illusory."
thoughtToHoldOnto: "Distinctive events paired with distinctive groups create memories that burn brighter - but brightness is not evidence."
whyItMattersNow: "Illusory correlations are a key mechanism behind stereotyping. When a minority group is associated with rare but memorable negative events, the pairing creates a perceived link that is far stronger than any statistical reality."
relatedConcepts:
  - slug: "confirmation-bias"
    note: "Once an illusory correlation forms, confirmation bias reinforces it by making you notice further cases that fit and ignore cases that don't."
  - slug: "apophenia"
    note: "Illusory correlation is apophenia applied to the relationship between two variables - seeing connections in randomness."
  - slug: "clustering-illusion"
    note: "Both involve perceiving structure in random data - the clustering illusion in sequences, illusory correlation in relationships."
  - slug: "availability-heuristic"
    note: "Distinctive pairings are easier to recall, which makes them feel more common - the availability heuristic fuels illusory correlations."
  - slug: "in-group-out-group-bias"
    note: "Illusory correlation is one of the cognitive mechanisms that creates and sustains out-group stereotypes."
---
...
The concept was first formally studied by psychologists Loren and Jean Chapman in the late 1960s, who demonstrated that people reliably perceived correlations in data where none existed. Their work revealed that [illusory correlations](https://en.wikipedia.org/wiki/Illusory_correlation) are not random errors. They follow predictable patterns, driven by how distinctive and emotionally salient the paired events are.
...
This is why illusory correlations are strongest when both elements of the pair are infrequent or attention-grabbing. A minority group member committing a minor infraction creates a far weaker memory than a minority group member committing a headline-grabbing crime. The distinctiveness of both the group membership and the behaviour creates a pairing that is easy to recall - which, through the [availability heuristic](/availability-heuristic/), makes it feel common.
...
This is [confirmation bias](/confirmation-bias/) reinforcing an illusory correlation. The initial perceived connection may have been created by a distinctive coincidence, but once it exists, it is maintained and strengthened by biased attention and memory.
...
This is connected to [in-group/out-group bias](/in-group-out-group-bias/), which amplifies the effect. Members of out-groups are already perceived as more distinctive and more homogeneous, which makes illusory correlations involving out-groups even stronger.
...
Illusory correlation sits at the crossroads of memory, perception, and social judgement. It is fuelled by the [availability heuristic](/availability-heuristic/) (distinctive pairings are easier to recall), maintained by [confirmation bias](/confirmation-bias/) (we selectively notice supporting instances), and rooted in [apophenia](/apophenia/) (the fundamental tendency to perceive connections in randomness). Understanding it is essential for understanding how stereotypes form, how folk beliefs persist, and how our sense of "what goes with what" can be deeply, systematically wrong.
