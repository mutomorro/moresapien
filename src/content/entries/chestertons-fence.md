...
oneLiner: "Before you remove something, make sure you understand why it was put there in the first place."
alsoKnownAs:
  - "Chesterton's gate"
  - "The fence principle"
...
tags:
  ...
  - "systems thinking"
  - "reform"
howToSpotIt: "Watch for people proposing to remove, abolish, or overhaul something without first explaining why it exists. Common forms include 'this process is pointless, let's scrap it,' 'this rule makes no sense,' or 'I don't see why we do it this way.' These might be correct conclusions - but Chesterton's Fence says you should arrive at them by understanding the original purpose, not by skipping that step."
thoughtToHoldOnto: "The fact that you can't see the reason for something doesn't mean there isn't one."
...
relatedConcepts:
  - slug: "second-order-thinking"
    note: "Understanding why the fence exists requires thinking about what happens when it's removed"
  - slug: "unintended-consequences"
    note: "Removing something you don't understand is a reliable way to produce consequences you didn't anticipate"
  - slug: "first-principles-thinking"
    note: "Complementary model - first principles builds from scratch, Chesterton's Fence says understand before you demolish"
  - slug: "status-quo-bias"
    note: "Chesterton's Fence is not status quo bias - it doesn't say don't change things, it says understand before you change them"
  - slug: "map-is-not-the-territory"
    note: "Your mental model of why something exists may not match the real reason it was built"
---
...
The [first principles thinking](/first-principles-thinking/) model offers a useful complement. Where Chesterton's Fence says "understand the existing structure before you change it," first principles says "build your understanding from the ground up rather than inheriting assumptions." Used together, they produce a powerful approach: first understand why things are the way they are, then evaluate whether the underlying reasoning still holds, then redesign from first principles if it doesn't.
