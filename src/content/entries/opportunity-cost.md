...
oneLiner: "Every choice has a hidden price: the thing you didn't choose."
alsoKnownAs: ["the hidden cost", "trade-offs", "the road not taken"]
category: "Mental Model"
tags: ["decision-making", "critical thinking", "everyday life", "workplace", "economics"]
howToSpotIt: "When evaluating a decision, ask not just 'what does this cost?' but 'what else could I do with the same time, money, or energy?' If you're spending Saturday on a mediocre commitment, the opportunity cost is whatever you'd most value doing instead. The cost is invisible unless you look for it."
thoughtToHoldOnto: "The true cost of anything isn't what you pay for it. It's what you give up to have it."
relatedConcepts:
  - slug: "sunk-cost-fallacy"
    note: "Sunk cost fallacy ignores opportunity cost entirely - it focuses on what you've already spent rather than what you could spend your resources on next."
  - slug: "loss-aversion"
    note: "Loss aversion makes opportunity costs invisible - the potential loss of what you have looms larger than the potential gain of what you could have."
