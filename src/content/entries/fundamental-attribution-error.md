...
oneLiner: "When others mess up, we blame their character. When we mess up, we blame the situation."
alsoKnownAs: ["correspondence bias", "attribution bias", "the actor-observer asymmetry"]
category: "Cognitive Bias"
tags: ["social dynamics", "everyday life", "relationships", "politics", "critical thinking", "workplace"]
howToSpotIt: "When you catch yourself making a character judgement about someone - lazy, stupid, selfish - ask whether the same behaviour in yourself would prompt the same conclusion, or whether you'd explain it away with circumstances. If the answer is different, attribution error is at work."
thoughtToHoldOnto: "Everyone is the hero of their own story. The person you just dismissed as an idiot has a whole inner world of reasons you know nothing about."
relatedConcepts:
  - slug: "in-group-out-group-bias"
    note: "We're more likely to make generous attributions for people in our group and harsh ones for outsiders."
  - slug: "just-world-fallacy"
    note: "The just-world fallacy is attribution error at scale - if bad things happen to people, they must deserve it."
