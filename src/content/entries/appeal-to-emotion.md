...
oneLiner: "Substituting feelings for evidence to win an argument."
alsoKnownAs:
...
thoughtToHoldOnto: "Feeling strongly about something is not the same as being right about it. The strength of your emotional reaction tells you nothing about the quality of the argument that triggered it."
whyItMattersNow: "Social media algorithms reward emotional intensity over accuracy. Content that makes you angry, afraid, or indignant spreads faster and further than content that calmly presents evidence. Understanding the appeal to emotion is one of the most practical defences against being manipulated online - not because emotions are bad, but because they make excellent camouflage for weak arguments."
relatedConcepts:
  - slug: "affect-heuristic"
    note: "The cognitive bias that makes appeal to emotion work - we judge things by how they make us feel."
  - slug: "framing-effect"
    note: "How the same facts can trigger completely different emotional responses depending on how they're presented."
  - slug: "confirmation-bias"
    note: "We're more susceptible to emotional appeals that confirm what we already believe."
