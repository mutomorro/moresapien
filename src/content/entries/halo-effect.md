---
title: "Halo Effect"
oneLiner: "One positive trait colours your entire perception of a person, product, or idea."
alsoKnownAs: ["halo bias", "physical attractiveness stereotype"]
category: "Cognitive Bias"
tags: ["perception", "everyday life", "workplace", "advertising", "social dynamics", "decision-making"]
howToSpotIt: "When you find yourself assuming someone is intelligent, trustworthy, or competent based on one impressive quality - their appearance, their job title, one good idea - check whether you have actual evidence for each of those traits, or whether one positive impression is doing all the work."
thoughtToHoldOnto: "A beautiful package tells you nothing about what's inside. But your brain will insist otherwise."
relatedConcepts:
  - slug: "authority-bias"
    note: "The halo effect explains part of why authority bias works - we assume competence in one domain extends to others."
  - slug: "bandwagon-effect"
    note: "Popularity creates its own halo - we assume popular things must be good because so many people like them."
