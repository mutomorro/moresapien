...
relatedConcepts:
  - slug: "feedback-loops"
    note: "Emergent behaviours often arise from feedback loops operating between many individual agents."
  - slug: "unintended-consequences"
    note: "Emergence is the systemic cousin of unintended consequences - complex outcomes nobody planned."
...
Most emergent phenomena rely on [feedback loops](/feedback-loops/) to amplify small initial changes into large-scale patterns. A few people start using a new phrase. Others hear it and repeat it. The phrase spreads. Soon it feels like everyone is saying it. The feedback between individual imitation and social reinforcement turns a small seed into a cultural pattern that nobody designed.

This is how trends form, how panics spread, and how norms shift. The [bandwagon effect](/bandwagon-effect/) is emergence in its social clothing - individual decisions to follow the crowd cascading through a population until a new consensus seems to appear from nowhere.
...
This is what makes misinformation so difficult to combat. A false claim doesn't spread because of a single coordinated campaign (though those exist too). It spreads because it triggers emotional reactions in individuals, each of whom shares it with their own network, each of whom does the same. The [availability heuristic](/availability-heuristic/) kicks in - because the claim keeps appearing, it feels true. By the time anyone tries to correct it, the emergent pattern has its own momentum.
