...
oneLiner: "Arguing that one step will inevitably lead to an extreme outcome, without justifying the chain of events in between."
alsoKnownAs: ["thin end of the wedge", "camel's nose", "domino fallacy"]
category: "Logical Fallacy"
tags: ["debate", "politics", "critical thinking", "media literacy", "persuasion"]
howToSpotIt: "When someone argues that allowing X will inevitably lead to Y, ask: what are the actual steps between X and Y? Is each step genuinely inevitable, or is the chain held together by assumption and fear rather than evidence?"
thoughtToHoldOnto: "Not every slope is slippery. Most paths have friction, barriers, and people making choices at every step."
whyItMattersNow: "Slippery slope arguments dominate debates about social change - from drug policy to AI regulation to marriage equality. They're effective precisely because they bypass evidence and go straight to fear."
relatedConcepts:
  - slug: "appeal-to-emotion"
    note: "Slippery slope arguments work by triggering fear of an extreme outcome rather than by providing evidence for the chain of events."
  - slug: "false-dilemma"
    note: "Both flatten complexity - false dilemmas reduce options to two, slippery slopes reduce a nuanced process to a single inevitable trajectory."
  - slug: "framing-effect"
