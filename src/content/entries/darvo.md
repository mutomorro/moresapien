---
title: "DARVO"
oneLiner: "Deny the behaviour, Attack the person who raised it, Reverse the roles of Victim and Offender."
alsoKnownAs: ["deny attack reverse", "playing the victim"]
category: "Manipulation Tactic"
tags: ["manipulation", "relationships", "politics", "critical thinking", "social dynamics", "debate"]
howToSpotIt: "When someone accused of wrongdoing immediately denies it, attacks the accuser's character or motives, and then positions themselves as the real victim - that's DARVO. The sequence matters: deny, attack, reverse. Watch for the pivot from 'I didn't do that' to 'how dare you accuse me' to 'actually, I'm the one being hurt here'."
thoughtToHoldOnto: "When the person who caused harm becomes the victim of the conversation, something has gone very wrong."
relatedConcepts:
  - slug: "gaslighting"
    note: "DARVO often includes gaslighting - the denial phase makes the accuser question whether the event happened at all."
  - slug: "psychological-projection"
    note: "The reversal phase of DARVO is projection in action - the offender projects victim status onto themselves."
  - slug: "whataboutism"
