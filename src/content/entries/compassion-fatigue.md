...
oneLiner: "Repeated exposure to suffering gradually reduces your capacity to care."
alsoKnownAs: ["empathy fatigue", "secondary traumatic stress", "the cost of caring"]
category: "Psychological Phenomenon"
tags: ["psychology", "news media", "social media", "everyday life", "critical thinking"]
howToSpotIt: "If you notice yourself scrolling past headlines about humanitarian disasters with less emotion than you once felt, or if 'another mass shooting' has become background noise, compassion fatigue has set in. It's not that you don't care. It's that your capacity to care has been depleted by overuse."
thoughtToHoldOnto: "Compassion fatigue is not a moral failure. It's a psychological injury. And like any injury, it needs attention, not guilt."
whyItMattersNow: "The 24/7 news cycle and social media expose us to more suffering than any generation in human history. Compassion fatigue isn't a risk - it's a near-certainty, and understanding it is essential to staying engaged without burning out."
relatedConcepts:
  - slug: "learned-helplessness"
    note: "Compassion fatigue and learned helplessness feed each other - when caring never seems to change anything, you stop caring and stop trying."
  - slug: "availability-heuristic"
    note: "Constant exposure to suffering via media makes it feel both overwhelming and, paradoxically, normal - the availability heuristic in two directions."
  - slug: "normalcy-bias"
