...
oneLiner: "Breaking a problem down to its most fundamental truths and reasoning up from there, rather than relying on analogy or convention."
alsoKnownAs: ["reasoning from first principles", "fundamental analysis", "Aristotelian method"]
category: "Mental Model"
tags: ["decision-making", "critical thinking", "everyday life", "workplace", "science"]
howToSpotIt: "When someone says 'we do it this way because that's how it's always been done' or 'everyone in the industry does it like this', those are signals that reasoning by analogy has replaced reasoning from evidence. Ask: what do we actually know to be true here, stripped of assumptions?"
thoughtToHoldOnto: "Convention tells you what is. First principles tell you what could be."
relatedConcepts:
  - slug: "occams-razor"
    note: "Both cut through complexity - Occam's Razor by favouring simplicity, first principles by stripping back to fundamentals."
  - slug: "independent-evaluation"
    note: "Independent evaluation is first principles thinking applied to claims - assessing evidence directly rather than deferring to consensus."
