...
oneLiner: "Changing the criteria for proof after the original criteria have been met."
alsoKnownAs: ["raising the bar", "shifting the standard", "the no true Scotsman's cousin"]
category: "Logical Fallacy"
tags: ["debate", "manipulation", "critical thinking", "politics", "workplace", "relationships"]
howToSpotIt: "If you meet someone's stated conditions and they immediately set new ones, the goalposts have moved. The clearest sign is the word 'but' - 'Yes, but now you need to...' Track the original ask. If it keeps changing, the person was never going to be satisfied."
thoughtToHoldOnto: "When the goalposts keep moving, the game was never about the goal. It was about keeping you running."
relatedConcepts:
  - slug: "sealioning"
    note: "Sealioning often involves moving the goalposts - each answered question produces another question, with no endpoint in sight."
  - slug: "circular-reasoning"
    note: "Both create unfalsifiable positions - circular reasoning defines its way out of challenge, goalpost-moving raises the bar each time it's met."
