...
oneLiner: "When all you have is a hammer, everything looks like a nail - the tendency to over-rely on a familiar tool or approach for every problem."
alsoKnownAs:
  - "Maslow's hammer"
  - "Golden hammer"
...
tags:
  ...
  - "everyday life"
  - "strategy"
howToSpotIt: "When your proposed solution looks suspiciously similar to your last three solutions, or when you instinctively reach for the same tool or framework regardless of the problem, the law of the instrument may be at work. The giveaway is consistency of approach across very different problems."
thoughtToHoldOnto: "The tool you know best is not always the tool the problem needs."
whyItMattersNow: "In an age of specialisation, people and organisations increasingly see the world through the lens of their particular expertise. Tech companies see technology solutions. Lawyers see legal solutions. Educators see education solutions. The law of the instrument explains why so many answers look like the question was written by the answerer."
relatedConcepts:
  - slug: "functional-fixedness"
    note: "Functional fixedness limits how you see objects; the law of the instrument limits how you see problems. Both constrain thinking to the familiar."
  - slug: "first-principles-thinking"
    note: "First principles thinking asks what the problem actually needs, rather than what your existing tools can provide."
  - slug: "circle-of-competence"
    note: "The circle of competence tells you where your tools work well. The law of the instrument is what happens when you use them outside that circle."
  - slug: "anchoring-bias"
    note: "Your most familiar tool anchors your thinking about solutions, making it harder to consider unfamiliar alternatives."
  - slug: "inversion"
    note: "Inversion helps break the law of the instrument by asking what would make the problem worse, rather than jumping to your default solution."
---
...
The concept has been discussed under various names since the 1960s, with contributions from Maslow, Abraham Kaplan, and others. It is closely related to [functional fixedness](/functional-fixedness/) - the inability to see an object beyond its conventional use - but operates at a higher level. Functional fixedness limits how you see objects. The law of the instrument limits how you see problems.
...
The law of the instrument connects to [functional fixedness](/functional-fixedness/) (seeing objects in limited terms), [circle of competence](/circle-of-competence/) (knowing where your tools work), [first principles thinking](/first-principles-thinking/) (defining problems from scratch rather than from your existing toolkit), and [anchoring bias](/anchoring-bias/) (your familiar tool anchoring your thinking). Together, they describe a common pattern: the tools we know shape what problems we can see, which shapes what solutions we consider - and sometimes the most important step is to put the hammer down.
