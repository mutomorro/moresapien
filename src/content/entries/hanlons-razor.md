...
oneLiner: "Never attribute to malice that which is adequately explained by incompetence, ignorance, or accident."
alsoKnownAs: ["Hanlon's law", "don't assume malice"]
category: "Mental Model"
tags: ["critical thinking", "relationships", "everyday life", "workplace", "social dynamics", "politics"]
howToSpotIt: "When something goes wrong and your first instinct is 'they did that on purpose', pause. Is there a simpler, less dramatic explanation? Cock-up is almost always more likely than conspiracy."
thoughtToHoldOnto: "Most of the harm in the world is caused not by evil people with plans, but by ordinary people who weren't paying attention."
relatedConcepts:
  - slug: "fundamental-attribution-error"
    note: "Hanlon's Razor is the direct antidote to attribution error - it pushes you to consider situational explanations before jumping to character judgements."
  - slug: "occams-razor"
    note: "Both razors cut in the same direction - toward simpler explanations. Occam's favours fewer assumptions; Hanlon's favours less malice."
  - slug: "naive-realism"
