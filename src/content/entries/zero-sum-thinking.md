...
oneLiner: "The assumption that any situation is a competition where one person's gain must be another's loss."
alsoKnownAs: ["zero-sum bias", "fixed-pie bias", "win-lose thinking"]
category: "Cognitive Bias"
tags: ["decision-making", "politics", "social dynamics", "economics", "everyday life", "critical thinking", "media literacy"]
howToSpotIt: "When someone frames a situation as 'us versus them' - where helping one group automatically hurts another - ask whether the pie is really fixed. In most real-world situations, it isn't. Trade, cooperation, and creative solutions can grow the total. If the argument only works by assuming there's a fixed amount to go around, zero-sum thinking is doing the heavy lifting."
thoughtToHoldOnto: "Most of life is not a poker game. The instinct to treat every situation as a competition is one of the deepest barriers to cooperation - and one of the easiest levers for anyone who wants to turn people against each other."
whyItMattersNow: "Zero-sum thinking is the silent engine behind much of today's most divisive political rhetoric. Immigration debates, welfare policy, culture wars - all are frequently framed as though one group's gain must come at another's expense. Once you see the frame, you see it everywhere."
relatedConcepts:
  - slug: "loss-aversion"
    note: "Loss aversion fuels zero-sum thinking - the fear of losing your share feels more urgent than the possibility that everyone's share could grow."
  - slug: "in-group-out-group-bias"
    note: "Zero-sum thinking is most powerful when combined with group identity - we're more willing to accept a bad deal if the 'other group' gets an even worse one."
  - slug: "framing-effect"
    note: "Whether a situation feels zero-sum often depends on how it's framed - the same policy can sound like shared prosperity or a threat to your slice."
  - slug: "scapegoating"
    note: "Scapegoating relies on zero-sum logic - the implicit argument is always that 'they' are taking what's 'ours'."
  - slug: "false-dilemma"
...
furtherReading:
  ...
  - title: "Zero-sum bias: perceived competition despite unlimited resources - Rozycka-Tran et al."
    url: "https://www.frontiersin.org/articles/10.3389/fpsyg.2015.00751/full"
---
...
This is also why [scapegoating](/scapegoating/) is so common in organisations under pressure. When resources tighten or results decline, the zero-sum frame activates: someone must be responsible for my group's losses. The scapegoat provides the answer. The implicit logic is always the same: "they" are taking what's "ours."
