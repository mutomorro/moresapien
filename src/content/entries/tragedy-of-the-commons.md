...
relatedConcepts:
  - slug: "second-order-thinking"
    note: "The tragedy unfolds because people think in first-order terms (my benefit now) rather than second-order terms (everyone's loss later)."
  - slug: "feedback-loops"
  ...
  - slug: "emergence"
    note: "The tragedy is an emergent outcome - no one intends the collapse, but it arises from the interaction of individually rational choices."
...
Email inboxes are a commons. Each sender's email is a rational act of communication. But the cumulative effect of everyone making that rational choice is inbox overload, declining response rates, and the degradation of email as a useful tool. [Social proof](/social-proof/) accelerates this - when you see others sending frequent updates and newsletters, the pressure to do the same increases.
...
The most important challenge came from the political scientist [Elinor Ostrom](https://en.wikipedia.org/wiki/Elinor_Ostrom), who won the Nobel Prize in Economics in 2009 for demonstrating that communities around the world have successfully managed commons for centuries - without privatisation and without government regulation.
