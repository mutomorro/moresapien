...
oneLiner: "When someone breaks from expected behaviour, you don't just notice - you react more strongly than the behaviour itself would normally warrant."
alsoKnownAs:
...
tags:
  ...
  - "persuasion"
  - "behaviour"
howToSpotIt: "When your emotional reaction to something someone does feels disproportionate - either much more positive or much more negative than the situation warrants - ask whether the reaction is really about what they did, or about the gap between what they did and what you expected them to do."
thoughtToHoldOnto: "We don't judge actions in isolation. We judge them against the script we had in our heads - and the distance between script and reality determines the strength of our response."
whyItMattersNow: "In a media landscape built on surprise, outrage, and disruption, expectancy violation is the psychological lever being pulled constantly. Understanding it helps explain why some moments go viral while objectively more important events pass without comment."
relatedConcepts:
  - slug: "framing-effect"
    note: "The frame through which we view someone sets the expectations they can then violate - framing and expectancy violation work as a pair."
  - slug: "halo-effect"
    note: "The halo effect sets positive expectations that, when violated, produce especially strong negative reactions."
  - slug: "fundamental-attribution-error"
    note: "When expectations are violated, we tend to attribute the violation to the person's character rather than their circumstances."
  - slug: "cognitive-dissonance"
    note: "An expectancy violation creates dissonance between what you believed about someone and what they just did."
  - slug: "anchoring-bias"
    note: "First impressions set anchors that become the baseline expectations against which all subsequent behaviour is measured."
---
...
This filtering is closely related to the [fundamental attribution error](/fundamental-attribution-error/). When a high-status or well-liked person violates expectations negatively, we're more inclined to attribute the violation to circumstances ("they must be having a bad day"). When a low-status or disliked person commits the same violation, we attribute it to character ("that's just what they're like").
...
[Cognitive dissonance](/cognitive-dissonance/) often follows an expectancy violation in relationships. When someone you trust deeply does something hurtful, the dissonance between "this person is trustworthy" and "this person just hurt me" creates significant psychological discomfort. The brain resolves this either by revising the view of the person or by minimising the significance of the violation - both of which have consequences for the relationship going forward.
...
Understanding this dynamic is useful for leadership. Strategic positive violations - doing something unexpectedly kind, generous, or honest - can have outsized effects precisely because they deviate from the expected pattern. The [social proof](/social-proof/) within a team also shapes these expectations: if the team culture expects a certain level of formality, someone who deviates from it will be evaluated through the lens of that deviation, not just on the merits of their behaviour.
...
The effectiveness depends on the direction of the violation relative to audience expectations. [Framing](/framing-effect/) is crucial here: if the audience has been primed to expect one thing, delivering another produces a cognitive jolt that increases attention and memorability. This is why unexpected openings to speeches - a silence, a personal confession, a question instead of a statement - are taught in communication training.
...
This connects to the [availability heuristic](/availability-heuristic/). Expectancy violations are inherently memorable - they stand out against the background of expected behaviour. This makes them more available to recall, which in turn makes them feel more common and more significant than they may be.
