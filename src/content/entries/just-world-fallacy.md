...
oneLiner: "The belief that people generally get what they deserve - that the world is fundamentally fair."
alsoKnownAs:
...
tags:
  ...
  - "everyday life"
  - "identity"
howToSpotIt: "Listen for explanations that blame outcomes on individual choices while ignoring systemic factors. If someone's response to poverty, illness, or misfortune is 'they must have done something wrong,' the just-world fallacy is doing the thinking."
thoughtToHoldOnto: "Bad things happen to good people. Accepting this is uncomfortable, but it's the beginning of honest thinking about the world."
relatedConcepts:
  - slug: "survivorship-bias"
    note: "Survivorship bias feeds the just-world fallacy - we see the winners and assume they deserved to win"
