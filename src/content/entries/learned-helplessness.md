...
oneLiner: "When repeated failure or lack of control teaches us to stop trying - even when things change."
...
tags:
  ...
  - "everyday life"
  - "relationships"
howToSpotIt: "Listen for 'what's the point?' and 'nothing ever changes.' If someone - or you - has stopped engaging not out of apathy but out of exhaustion and futility, learned helplessness may be at work. The question is whether the situation has actually changed while the response hasn't."
thoughtToHoldOnto: "The feeling that nothing you do matters is sometimes a fact about the situation. But often it's a scar from a previous situation that no longer applies."
relatedConcepts:
  - slug: "firehose-of-falsehood"
    note: "The firehose strategy's ultimate goal is learned helplessness - people giving up on determining what's true"
