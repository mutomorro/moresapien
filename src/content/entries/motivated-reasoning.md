...
oneLiner: "Using our intelligence not to find truth but to defend conclusions we've already reached."
...
tags:
  ...
  - "science"
  - "everyday life"
howToSpotIt: "Ask yourself: am I reasoning towards a conclusion, or from one? If you started with the answer and are now building the case for it, that's motivated reasoning. The smarter you are, the better you'll be at constructing convincing justifications."
thoughtToHoldOnto: "Intelligence is a tool. It can be used to find the truth or to avoid it. Motivated reasoning is intelligence in the service of self-deception."
relatedConcepts:
  - slug: "confirmation-bias"
    note: "Confirmation bias is the passive version - motivated reasoning is the active version"
